...
namespace CodeTitans.JSon
{
    ...
    public sealed class JSonMemberAttribute : Attribute
    {
        ...
        {
            Name = name;
            DefaultValue = new JSonDecimalObject<Single>(defaultValue);
        }
        ...
        {
            Name = name;
            DefaultValue = new JSonDecimalObject<Int64>(defaultValue);
        }
        ...
        /// <summary>
        /// Gets or sets an indication if an JSonMemberMissingException should be thrown, when field or property is missing during deserialization.
        /// </summary>
        public bool SupressThrowWhenMissing
        { get; set; }
